...
namespace AppServices.EntityServices
{
    public class RepartoServices: IRepartoServices
    {
        ...
        public void Add(Reparto reparto, ICollection<DiaReparto> diaRepartos)
        {
            Reparto repartoMismoDiaNombre = diaRepartos.ToList().Find(d => d.Id == reparto.DiaRepartoId).Repartos.FirstOrDefault(r => r.Nombre == reparto.Nombre);
