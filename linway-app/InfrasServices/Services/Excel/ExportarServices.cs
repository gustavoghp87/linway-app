...
namespace linway_app.Services.Excel
{
    public class ExportarServices : IExportarServices
    {
        ...
        public void ExportarVentas(ICollection<Venta> lstVentas)
        {
            if (lstVentas == null)
            {
                throw new Exception("No hay Ventas para exportar");
            }
        ...
        public void ExportarReparto(Reparto reparto)
        {
            if (reparto == null)
            {
        ...
        public void ExportarNotas(ICollection<NotaDeEnvio> notas)
        {
            if (notas == null || notas.Count == 0)
            {
                throw new Exception("No hay Notas para exportar");
            }
