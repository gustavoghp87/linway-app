...
namespace linway_app.Excel
{
    public class Exportar
    {
        ...
        public bool ExportarVentas(List<Venta> lstVentas)
        {
            ...
            string path = @"Excels/ventas-" + DateTime.UtcNow.ToString(FormatoDeFecha) + "-" + GetTimestamp() + ".";
            try
            {
                ...
                cell1b.SetCellValue(DateTime.UtcNow.ToString(FormatoDeFecha));
        ...
        public bool ExportarReparto(Reparto reparto)
        {
            ...
            string path = @"Excels/reparto-"
                + DateTime.UtcNow.ToString(FormatoDeFecha) + "-"
            ...
            try
            {
                ...
                cell3.SetCellValue("PRODUCTOS      (Impreso " + DateTime.UtcNow.ToString(FormatoDeFecha) + ")");
                cell3.CellStyle = style1;
